...
const VIDEOS: Record<Level, VideoCard[]> = {
  ...
  mid: [
    ...
    },
    {
      ...
      url: "https://www.youtube.com/watch?v=bE1iSUYA0KI",
      videoId: "bE1iSUYA0KI",
    ...
    },
    {
      ...
      duration: "영상별 상이",
      tags: ["거시경제", "금리", "환율", "경제기초"],
      url: "https://www.youtube.com/watch?v=3vIURu8WZmk",
      videoId: "3vIURu8WZmk",
  ...
  advanced: [
    ...
    },
    {
      ...
      url: "https://www.youtube.com/watch?v=BEUvOl-expQ",
      videoId: "BEUvOl-expQ",
  ...
  bonus: [
    {
      title: "주식은 지금 — 슈카친구들에 다니면 돈을 벌까 잃을까",
      channel: "머니코믹스",
      channelBadge: "💰",
      description: "알상무·니니와 함께 시장 흐름과 종목을 예능 형식으로 분석하는 머니코믹스 대표 시리즈. 슈카 멤버들의 실제 투자 성과 공개.",
      duration: "1~2시간",
      tags: ["시장분석", "실전투자", "슈카친구들"],
      url: "https://www.youtube.com/watch?v=mg8_BRcF7uQ",
      videoId: "mg8_BRcF7uQ",
      color: "from-purple-500/20 to-pink-500/10",
    },
    {
      title: "개미는 지금 — 진짜 개미투자, 계좌 다 깝니다!",
      channel: "머니코믹스",
      channelBadge: "🐜",
      description: "개인투자자들의 실제 매매 계좌를 공개하며 투자 전략과 고민을 솔직하게 터놓는 머니코믹스 개미투자 특집.",
      duration: "1~2시간",
      tags: ["개인투자", "계좌공개", "실전매매"],
      url: "https://www.youtube.com/watch?v=AS16T002-K8",
      videoId: "AS16T002-K8",
      color: "from-pink-500/20 to-rose-500/10",
    },
    {
      title: "미장은 지금 — 금리·환율 안정 vs 경기 부양",
      channel: "머니코믹스",
      channelBadge: "🇺🇸",
      description: "미국 시장 분석 전문가 윤지호와 함께 한국·미국 금리·환율 딜레마와 글로벌 자산 시장 흐름을 깊이 파헤칩니다.",
      duration: "1~2시간",
      tags: ["금리", "환율", "미국시장", "거시경제"],
      url: "https://www.youtube.com/watch?v=yMIZDtIyQlE",
      videoId: "yMIZDtIyQlE",
      color: "from-blue-500/20 to-cyan-500/10",
    },
    {
      title: "해피떨스데이 — 서울대 경제학과 형님들, 주식 얼마나 벌었나",
      channel: "머니코믹스",
      channelBadge: "🎉",
      description: "경제학 전공자들이 실제로 주식으로 돈을 버는지 솔직하게 따져보는 머니코믹스 특집. 이론 vs 실전의 충돌.",
      duration: "1~2시간",
      tags: ["공개토론", "경제학", "실전투자"],
      url: "https://www.youtube.com/watch?v=rHROYYOBG-4",
      videoId: "rHROYYOBG-4",
